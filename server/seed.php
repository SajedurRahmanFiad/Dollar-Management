...
$customers = [
    ['name' => 'Tanvir Ahmed', 'phone' => '+880 1711-234567', 'company_name' => 'Tanvir Ahmed Trading', 'notes' => 'Major SaaS & software importer. Reliable payer, prefers BRAC Bank or City Bank.', 'preferred_channel' => 'WhatsApp', 'avatar_color' => 'bg-blue-600', 'created_at' => '2026-06-10 10:00:00'],
    ['name' => 'Nusrat Jahan', 'phone' => '+880 1819-876543', 'company_name' => 'Nusrat Digital Studio', 'notes' => 'Digital agency founder. Buys $1,500-$3,000 bi-weekly for Facebook and Google ad spends.', 'preferred_channel' => 'Telegram', 'avatar_color' => 'bg-emerald-600', 'created_at' => '2026-07-02 14:30:00'],
    ['name' => 'Rafiqul Islam', 'phone' => '+880 1912-334455', 'company_name' => 'Rafiqul Imports', 'notes' => 'Import goods merchant. Deals in bulk $2,000-$5,000. Pays via bKash Merchant and BEFTN.', 'preferred_channel' => 'Phone', 'avatar_color' => 'bg-amber-600', 'created_at' => '2026-07-15 09:15:00'],
    ['name' => 'Farhan Chowdhury', 'phone' => '+880 1622-998877', 'company_name' => 'Farhan Tech Consulting', 'notes' => 'Tech consultant. Occasional large purchases. Very communicative on WhatsApp.', 'preferred_channel' => 'WhatsApp', 'avatar_color' => 'bg-violet-600', 'created_at' => '2026-08-01 11:45:00'],
    ['name' => 'Tahmid Rahman', 'phone' => '+880 1755-443322', 'company_name' => 'Tahmid Cloud Services', 'notes' => 'Cloud architect. Regular small-to-medium transfers for cloud infrastructure.', 'preferred_channel' => 'Messenger', 'avatar_color' => 'bg-cyan-600', 'created_at' => '2026-08-10 16:20:00'],
    ['name' => 'Shuvo Karim', 'phone' => '+880 1533-112233', 'company_name' => 'Shuvo Media Solutions', 'notes' => 'New client referred by Tanvir Ahmed. Needs USD for advertising credits.', 'preferred_channel' => 'WhatsApp', 'avatar_color' => 'bg-rose-600', 'created_at' => '2026-08-25 08:00:00'],
];

$stmt = $db->prepare('INSERT INTO customers (name, phone, company_name, notes, preferred_channel, avatar_color, created_at) VALUES (?, ?, ?, ?, ?, ?, ?)');
foreach ($customers as $c) {
    $stmt->execute([$c['name'], $c['phone'], $c['company_name'], $c['notes'], $c['preferred_channel'], $c['avatar_color'], $c['created_at']]);
}
...
$timelineEvents = [
    ...
    [1, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created', 'Agreement finalized for $2,000 at rate ৳123.00/USD. Expected total: ৳246,000.', 2000, 246000, 123.00, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-2 days'))],
    [1, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Transfer Proof Sent', 'Dispatched $2,000 to customer wallet via Binance Pay. Awaiting customer confirmation.', 2000, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-2 days'))],
    ...
    [1, 'payment_approved', 'owner', 'Ahmed Sourov', 'Payment Approved (৳150,000)', 'Bank receipt verified. ৳150,000 deducted from outstanding balance. Remaining due: ৳96,000.', null, 150000, null, null, null, null, 'pay-2405-a', null, date('Y-m-d H:i:s', strtotime('-1 day'))],
    ...
    [2, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created from Request REQ-107', 'Agreement for $1,500 @ ৳122.50 = ৳183,750.', 1500, 183750, 122.50, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-5 hours'))],
    [2, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Transfer Proof Sent', 'Transferred $1,500 via Wise USD. Screenshot attached. Waiting for customer confirmation.', 1500, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-4 hours'))],

    // DL-2406 (deal_id=3) timeline
    [3, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created', 'Agreement finalized for $4,000 at rate ৳123.20. Expected total: ৳492,800.', 4000, 492800, 123.20, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-3 days'))],
    [3, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Transfer Proof Sent', '$4,000 sent via Payoneer. Screenshot attached.', 4000, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-3 days'))],
    ...
    [4, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created', 'Deal agreed for $3,200 @ ৳122.00 = ৳390,400.', 3200, 390400, 122.00, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-6 days'))],
    [4, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Proof Uploaded', 'Sent $3,200 via Binance Pay.', 3200, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-6 days'))],
    ...
    [4, 'payment_approved', 'owner', 'Ahmed Sourov', 'Payment Approved (৳200,000)', 'Applied ৳200,000 payment. Outstanding balance reduced to ৳190,400.', null, 200000, null, null, null, null, 'pay-2403-a', null, date('Y-m-d H:i:s', strtotime('-5 days'))],

    // DL-2402 (deal_id=5) timeline
    [5, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created', '$5,000 @ ৳121.80 = ৳609,000.', 5000, 609000, 121.80, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-14 days'))],
    [5, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Proof Uploaded', 'Sent $5,000 to Wise account.', 5000, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-14 days'))],
    ...
    [5, 'payment_approved', 'owner', 'Ahmed Sourov', 'Payment Approved (৳609,000)', 'Payment verified in bank account.', null, 609000, null, null, null, null, 'pay-2402-a', null, date('Y-m-d H:i:s', strtotime('-12 days'))],
    ...
    [6, 'deal_created', 'owner', 'Ahmed Sourov', 'Deal Created', '$850 @ ৳123.50 = ৳104,975.', 850, 104975, 123.50, null, null, null, null, null, date('Y-m-d H:i:s', strtotime('-20 days'))],
    [6, 'dollar_proof_uploaded', 'owner', 'Ahmed Sourov', 'Dollar Proof Uploaded', '$850 sent to customer wallet.', 850, null, null, null, 'usd_sent', null, null, null, date('Y-m-d H:i:s', strtotime('-20 days'))],
    ...
    [6, 'payment_approved', 'owner', 'Ahmed Sourov', 'Payment Approved', 'Full payment verified.', null, 104975, null, null, null, null, 'pay-2401-a', null, date('Y-m-d H:i:s', strtotime('-19 days'))],
